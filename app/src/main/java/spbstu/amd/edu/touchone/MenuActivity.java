    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener oclButtonLevel = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MenuActivity.this, "Clicked level button", Toast.LENGTH_SHORT).show();
        ...
        View.OnClickListener oclButtonAbout = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MenuActivity.this, "Clicked about button", Toast.LENGTH_SHORT).show();
        ...
        View.OnClickListener oclButtonQuit = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MenuActivity.this, "Clicked quit button", Toast.LENGTH_SHORT).show();
                System.exit(0);
            }
        };
